...
function getCurrencies(currencies) {
    if (currencies.length === 2) return `and you can pay with ${currencies[0].name} and ${currencies[1].name}'s`;
...
},{"axios":"1IeuP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["6BPv4","1hFYX"], "1hFYX", "parcelRequirecb08")
